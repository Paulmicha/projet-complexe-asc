...
# global DRUPAL_TRANSLATION_DIR "[default]=$SERVER_DOCROOT/sites/default/files/translations"
...
global WRITEABLE_DIRS "[append]=$DRUPAL_TRANSLATION_DIR"
global WRITEABLE_DIRS "[append]=$DRUPAL_PRIVATE_DIR"
global WRITEABLE_DIRS "[append]=$DRUPAL_CONFIG_SYNC_DIR"

# TODO only target some specfiic vendors by default (drush, drupal console) ?
