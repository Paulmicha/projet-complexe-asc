...
#   # Or :
#   asc/extensions/remote_asc/db/dl_from.sh my_remote_id
#   asc/extensions/remote_asc/db/dl_from.sh my_remote_id new
#   asc/extensions/remote_asc/db/dl_from.sh my_remote_id path/to/remote/dump/file.sql.tgz
#
