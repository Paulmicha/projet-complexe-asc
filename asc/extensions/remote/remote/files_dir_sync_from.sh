...
#   # Or :
#   asc/extensions/remote/remote/files_dir_sync_from.sh
#
#   # From the 'preprod' remote :
#   make remote-files-dir-sync-from 'preprod'
#   # Or :
#   asc/extensions/remote/remote/files_dir_sync_from.sh 'preprod'
#
#   # Only 'public' files :
#   make remote-files-dir-sync-from 'prod' 'public'
#   # Or :
#   asc/extensions/remote/remote/files_dir_sync_from.sh 'prod' 'public'
#
