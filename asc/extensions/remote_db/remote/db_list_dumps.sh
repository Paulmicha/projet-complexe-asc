...
#   # Or :
#   asc/extensions/remote_db/remote/db_list_dumps.sh 'preprod'
#
#   # Only specific DB ID(s) :
#   make remote-db-list-dumps 'prod' 'default'
#   make remote-db-list-dumps 'dev' 'api'
#   # Or :
#   asc/extensions/remote_db/remote/db_list_dumps.sh 'prod' 'default'
#   asc/extensions/remote_db/remote/db_list_dumps.sh 'dev' 'api'
#
